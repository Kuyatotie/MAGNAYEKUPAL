...
<div class="row footer">
  ...
  <a href="about.php">Visit Example Website</a>
  </div>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="young.jpg" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Young</a>
		...
		<h4 style="font-family:'typo' ">Asian Institue of computer Studies</h4></div></div>
		</p>
      </div>
