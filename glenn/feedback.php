...
<div class="col-md-6 panel" style="background-image:url(image/bobo.jpg);background-repeat: no repeat;background-position: center; background-size: 110vh">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/rd.jpg" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">RD DOCOR/a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1"></h4>
		<h4 style="font-family:'typo' ">School: AICS</h4>
		<h4 style="font-family:'typo' ">Course: Bachelor Science in computer Science</h4></div></div>
		</p>
      </div>
